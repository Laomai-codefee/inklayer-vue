// InkLayer Vue — shared type definitions
// Adapted from React version: React.ReactNode → string | Vue Component
//                            React.CSSProperties → CSSProperties object
...
export interface PdfBaseProps {
   ...
   */
  theme?:
    | 'ruby' | 'indigo' | 'gray' | 'gold' | 'bronze' | 'brown'
    | 'yellow' | 'amber' | 'orange' | 'tomato' | 'red' | 'crimson'
    | 'pink' | 'plum' | 'purple' | 'violet' | 'iris' | 'blue'
